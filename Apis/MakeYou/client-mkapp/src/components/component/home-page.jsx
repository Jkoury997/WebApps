...
const colors = {
  primary: "#FF69B4",       // Rosa pastel fuerte
  secondary: "#FFB6C1",     // Rosa claro
  accent: "#FF1493",        // Rosa intenso
  background: "#FFF0F5",    // Lavanda muy claro
  text: "#4B0082",          // Índigo oscuro
  muted: "#D8BFD8"          // Cardo (un tono de púrpura claro)
};
        ...
        <div className="container flex h-14 items-center">
          <div className="mr-4 hidden md:flex">
            <a className="mr-6 flex items-center space-x-2" href="/">
              ...
              <span className="hidden font-bold sm:inline-block">Fichaqui MakeYou</span>
            </a>
